            ...
            <div class="admin-form-center">
                ...
                <form class="admin-form" method="post" action="">
                    <div class="admin-form-grid">
                        ...
                        <label class="admin-form-row">
                            <span>Team Side</span>
                            <?php $injurySide = $_POST['team_side'] ?? 'home'; ?>
                            <select class="admin-select" name="team_side">
                                <option value="home" <?php echo $injurySide === 'home' ? 'selected' : ''; ?>>Home</option>
                                <option value="away" <?php echo $injurySide === 'away' ? 'selected' : ''; ?>>Away</option>
                            </select>
                        </label>
                        <label class="admin-form-row">
                    ...
                    <a class="admin-link" href="../lineups.php?match_id=<?php echo (int) $selectedMatchId; ?>&section=injuries">Back to lineups</a>
                        <button class="admin-btn admin-btn-primary" type="submit">Add Injury</button>
                    </div>
                </form>
            </div>
        </section>
