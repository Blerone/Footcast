...
// Load bets (parlay selections as bets)
$bets = [];
$betsSql = "
    SELECT
        ps.id,
    ...
    <main class="admin-main">
        <section class="admin-hero">
            <div class="admin-hero-text">
                <h1>All Bets</h1>
                <p>Parlay selections treated as individual bets.</p>
            </div>
        </section>
        ...
        <section class="admin-section admin-section-active">
            <div class="admin-section-header">
                <h2>All Bets</h2>
                <p>Filter by status to inspect settlement.</p>
            </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($bets as $b): ?>
                                ...
                                <tr data-status="<?php echo htmlspecialchars($status, ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <td><?php echo htmlspecialchars($b['username'], ENT_QUOTES, 'UTF-8'); ?></td>
                                    <td><?php echo htmlspecialchars($b['match_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                                    <td><?php echo htmlspecialchars($b['bet_type'], ENT_QUOTES, 'UTF-8'); ?></td>
                                    <td>$<?php echo number_format((float) $b['stake'], 2); ?></td>
                                    <td><?php echo number_format((float) $b['odds'], 2); ?></td>
                                    <td>$<?php echo number_format((float) $b['potential_payout'], 2); ?></td>
                                    <td>
                                    ...
                                    <td><?php echo htmlspecialchars(date('n/j/Y, g:i A', strtotime($b['created_at'])), ENT_QUOTES, 'UTF-8'); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
