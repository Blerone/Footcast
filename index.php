...
<body>
  ...
  <div class="main-content">
    <div class="content-wrapper">
      <div class="purple-section">
        <div class="hero-text">
          <h2 class="sports-text">SPORTS</h2>
  ...
  <div class="trusted-by">
    <h2 class="trusted-by-text">Trusted By</h2>
  ...
  <section class="about-us">
    <div class="left-text">
      <h1>One click from <span>Winning It All</span></h1>
      <p>FootCast is your go-to spot for football betting done right. Place smart bets, follow live stats, and stay
        ahead with real-time insights. From major leagues to local matches, FootCast keeps every game exciting where
  ...
  <section class="bet-steps">
    <h1> How to place a <span>BET</span> ?</h1>
    ...
    <div class="leagues-inner premier">
      ...
      <div class="inside-leagues">
        <div class="leagues-leftside">
          <p class="label">Top Goal Scorer</p>
  ...
  <div class="favorites-heading">
    <h1>Fan’s <span>FAVORITE</span></h1>
    <div class="underline3"></div>
  </div>
